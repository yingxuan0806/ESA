...
# Script for Lecture 16 (Activity 1a,b,c)


######## Set the working environemnt and load packages

# Remove all variables from the R environment to create a fresh start
rm(list=ls())

# Set the working folder
setwd("~/Documents/SUTD/Term 5/ESA/Week 10/Lecture 16")
...
# [1] 0.0 4.5 0.0 (value of the decision variables)
#
...
#
# Alternatively, we can simply store all info related to the lp in a list
...
# [1] 1 4 0
#
# You can get sensitivities in the integer case, but they're harder to interpret
#
...
# The 13 nuclear plants found in Problem 1 are repalced by 1 coal plant, 20 CCGT plants, 18 wind turbines
